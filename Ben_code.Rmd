...
SC_map = ggplot() +
  geom_sf(data=DHEC_projected, aes(color = "pink", fill="303_d"))+
  geom_sf(data=Water_projected, alpha=0.5, aes(color = "black", fill="Water_bodies")) +
  geom_sf(data=Stations_projected, aes(color = "yellow", fill="Stations")) +
